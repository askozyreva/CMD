...
glm_0 <-
  glm(
    rating_bi ~ vaccines_cause_infertility + party  + age + education + gender_bi,
    data = subset_0
  )
...
glm_0 <-
  glm(
    rating_bi ~ election_was_stolen + party  + age + education + gender_bi, data = subset_0
  )

glm_1 <-
  glm(
    rating_bi ~ election_was_stolen + party   + age + education + gender_bi, data = subset_1
  )
...
glm_0 <-
  glm(
    rating_bi ~ holocaust_is_fact + party  + age + education + gender_bi, data = subset_0
  )

glm_1 <-
  glm(
    rating_bi ~ holocaust_is_fact + party   + age + education + gender_bi, data = subset_1
  )
...
glm_0 <-
  glm(
    rating_bi ~ climate_change_true + party  + age + education + gender_bi, data = subset_0
  )

glm_1 <-
  glm(
    rating_bi ~ climate_change_true + party   + age + education + gender_bi, data = subset_1
  )
...
glm_0 <-
  glm(
    rating_bi ~ vaccines_cause_infertility + party  + age + education + gender_bi, data = subset_0
  )

glm_1 <-
  glm(
    rating_bi ~ vaccines_cause_infertility + party   + age + education + gender_bi, data = subset_1
  )
...
atme_plot_all_acc <- diff_table_all_acc %>%
  ...
  labs(title = "A. Moderation effects of beliefs on dichotomized rating to suspend accounts",
       y = "Moderation by accuracy of the effect of conjoint attributes on probability to suspend account",
       x = "")
atme_plot_all_acc
...
atme_plot_all_party <- diff_table_all_party %>%
  ...
  labs(title = "B. Moderation effects of partisanship on dichotomized rating to suspend accounts",
       y = "Moderation by partisanship of the conjoint attributes on probability to suspend account",
       x = "")
atme_plot_all_party



moderation_rating_bi <-
  plot_grid(
    atme_plot_all_acc,
    atme_plot_all_party,
    ncol = 1,
...
ggsave(
  filename = here("figs/SI_moderation_rating_bi.png"),
  plot = moderation_rating_bi,
  dpi = 300,
  units = 'cm',
  height = 22,
  width = 17.8
...
ggsave(
  filename = here("figs/SI_moderation_rating_bi.pdf"),
  plot = moderation_rating_bi,
  dpi = 300,
  units = 'cm',
  height = 22,
